...
@PageTitle("in-block-actual-time")
@Route(value = "/ws/in-block-actual-time", layout = MainLayout.class)
public class InBlockTimeView extends VerticalLayout {
    ...
    public InBlockTimeView(@Value("${websocket.handshake-url.in-block-actual-time}") String webSocketConnectionUrl,
