...
@PageTitle("landing-estimated-time")
@Route(value = "/ws/landing-estimated-time", layout = MainLayout.class)
public class LandingTimeView extends VerticalLayout {
    ...
    public LandingTimeView(@Value("${websocket.handshake-url.landing-estimated-time}") String webSocketConnectionUrl,
